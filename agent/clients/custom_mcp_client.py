...
class CustomMCPClient:
        ...
        async with self.http_session.post(
            ...
            if not self.session_id:
                ...
                if new_session_id:
                    ...
                    print(f"Established MCP session: {self.session_id}")
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            capabilities = init_response.get("result", {})
    ...
    async def _send_notification(self, method: str) -> None:
        ...
        async with self.http_session.post(
            ...
            session_header = response.headers.get(MCP_SESSION_ID_HEADER)
            if session_header:
                self.session_id = session_header
                print(f"Notification acknowledged for session: {self.session_id}")
