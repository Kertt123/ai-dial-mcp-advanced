...
class MCPServer:
    ...
    def handle_initialize(self, request: MCPRequest) -> tuple[MCPResponse, str]:
        ...
        requested_version = request.params.get("protocolVersion") if request.params else self.protocol_version
        protocol_version = self._validate_protocol_version(requested_version or self.protocol_version)
